...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/3.0.8-SNAPSHOT/reference/htmlsingle/#web.security.oauth2.client)
* [Spring LDAP](https://docs.spring.io/spring-boot/docs/3.0.8-SNAPSHOT/reference/htmlsingle/#data.nosql.ldap)
* [Okta Spring Boot documentation](https://github.com/okta/okta-spring-boot#readme)
* [MyBatis Framework](https://mybatis.org/spring-boot-starter/mybatis-spring-boot-autoconfigure/)
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.0.8-SNAPSHOT/reference/htmlsingle/#actuator.metrics.export.prometheus)
